      ...
      <div className="max-w-7xl mx-auto py-6 sm:px-6 lg:px-8">
        <div className="px-4 py-6 sm:px-0">
          ...
          <div className="bg-white shadow rounded-lg overflow-hidden">
            {activeTab === 'chatbot' && (
              <iframe src={\`http://localhost:8081/embed/chatbot?license=\${licenseKey}\`} width="100%" height="800px" style={{border: 'none'}}></iframe>
            )}
            {activeTab === 'livechat' && (
              <iframe src={\`http://localhost:8081/embed/livechat?license=\${licenseKey}\`} width="100%" height="800px" style={{border: 'none'}}></iframe>
            )}
          </div>
        </div>
      </div>
        ...
        <div class="px-4 py-6 sm:px-0">
            ...
            <div class="bg-white shadow rounded-lg overflow-hidden">
                <div x-show="activeTab === 'chatbot'">
                    <iframe src="http://localhost:8081/embed/chatbot?license={{ $licenseKey ?? '${licenseKey}' }}" width="100%" height="800px" style="border:none;"></iframe>
                </div>
                <div x-show="activeTab === 'livechat'" style="display: none;">
                    <iframe src="http://localhost:8081/embed/livechat?license={{ $licenseKey ?? '${licenseKey}' }}" width="100%" height="800px" style="border:none;"></iframe>
                </div>
            </div>
        </div>
    </div>
